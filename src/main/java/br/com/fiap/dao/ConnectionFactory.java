    ...
    public Connection getConexao() {
        try {
            ...
            if (this.getDriver() == null || this.getDriver().isEmpty()) {
                throw new ClassCastException("Nome da classe nulo ou em branco");
            }
            if (this.getUrl() == null || this.getUrl().isEmpty()) {
                throw new ClassCastException("URL de conexão nulo ou em branco");
            }
            if (this.getUser() == null || this.getUser().isEmpty()) {
                throw new ClassCastException("Usuário nulo ou em branco");
            }
